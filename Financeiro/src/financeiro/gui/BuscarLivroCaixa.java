 ...
 * @author Ledilson
 */
public class BuscarLivroCaixa extends javax.swing.JFrame {

    /**
     * Creates new form BuscarLivroCaixa
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarLivroCaixa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarLivroCaixa().setVisible(true);
            }
        });
    }
