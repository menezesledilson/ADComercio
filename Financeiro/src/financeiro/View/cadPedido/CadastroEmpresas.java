...
private void CentralizarTabela() {
        ...
        tbCadEmpresa.getColumnModel().getColumn(2).setCellRenderer(centerRenderer);
        tbCadEmpresa.getColumnModel().getColumn(3).setCellRenderer(centerRenderer);
        tbCadEmpresa.getColumnModel().getColumn(4).setCellRenderer(centerRenderer);
    }
    ...
    public void carregaTabela() {
        ...
        tbCadEmpresa.getColumnModel().getColumn(0).setPreferredWidth(200);
